Followed Ben Eater's Youtube tutorial for building an 8 bit breadboard computer using ICs, an EEPROM programmed with an arduino nano, output module with 7 segment displays, and other circuit components.
